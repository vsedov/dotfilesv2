...
export PTPYTHON_CONFIG_HOME=/home/viv/.config/ptpython/

export PATH="$(ruby -e 'print Gem.user_dir')/bin:$PATH"
export PATH="$PATH:$HOME/.julia/bin/"
export PATH="$PATH:$HOME/.cargo/bin/"
export PATH=$HOME/.local/share/bob/nvim-bin/:/usr/local/bin/:/usr/bin:$PATH

if [ -n "$PYTHONPATH" ]; then
    export PYTHONPATH='/home/viv/.config/pdm/pep582':$PYTHONPATH
else
    export PYTHONPATH='/home/viv/.config/pdm/pep582'
fi
